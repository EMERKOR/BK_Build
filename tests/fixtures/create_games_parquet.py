"""
Script to create synthetic games.parquet fixture for testing

This creates a minimal parquet file with fake game data to allow
...
# Save to parquet
output_path = Path(__file__).parent / "games.parquet"
